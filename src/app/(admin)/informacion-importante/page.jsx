...
import { deleteInformacionImportanteAction } from "@/lib/actions";
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/informacion-importante/nuevo"
      ...
      {documentos.length === 0 && !loadError ? (
        <div className="bg-white border border-gray-200 rounded-lg p-10 text-center shadow-sm">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Agrega el primero para que aparezca en el inicio del sitio.
          </p>
          <Link
            href="/informacion-importante/nuevo"
                ...
                {documentos.map((d) => (
                  <tr key={d.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-right whitespace-nowrap">
                      ...
                      <Link
                        href={`/informacion-importante/${d.id}/editar`}
                        className="text-sm font-medium text-sidebar hover:underline mr-4"
                      >
                        Editar
                      </Link>
