...
import { replacePortadaHistoriaAction } from "@/lib/actions";

export default function UploadPortadaHistoriaForm({ tieneImagenPropia }) {
  const [state, formAction, pending] = useActionState(
    replacePortadaHistoriaAction,
    {},
  );
    ...
    >
      <div>
        <h2 className="text-lg font-semibold text-gray-900">
          {tieneImagenPropia ? "Reemplazar imagen" : "Subir imagen"}
        </h2>
        <p className="text-sm text-gray-600 mt-1">
          Selecciona una imagen panorámica horizontal. Recomendado: mínimo
          1920 × 1080 píxeles. Formatos: JPG, PNG, WebP.
        </p>
      </div>
