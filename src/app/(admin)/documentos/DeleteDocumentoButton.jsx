...
import { deleteDocumentoAction } from "@/lib/actions";

export default function DeleteDocumentoButton({ id, titulo }) {
  const [state, formAction, pending] = useActionState(deleteDocumentoAction, {});
