...
export default function SevacForm({
  action,
  initialData = null,
  submitLabel = "Guardar",
}) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            placeholder="CUENTA_PUBLICA, INFORME_TRIMESTRAL…"
            className={INPUT_CLASS}
          />
          <datalist id="cat-sevac">
            {CATEGORIAS.map((c) => (
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={() => router.push("/transparencia/sevac")}
